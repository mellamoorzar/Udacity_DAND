...
### Plot Three
```{r Cut_Sulphates, echo=FALSE}
# cut sulphates variable
red_wine$sulphates.bucket <- cut(log10(red_wine$sulphates), 
                             c(-Inf, -0.2596, -0.2076, -0.1367, +Inf))
```

```{r Plot_Three, echo=FALSE}
ggplot(red_wine[order(red_wine$sulphates, decreasing = F), ],
       aes(x = volatile.acidity, y = alcohol,
  ...
  theme_minimal() +
  ggtitle('Alcohol, Volatile Acidity and Sulphates with Quality')
```
